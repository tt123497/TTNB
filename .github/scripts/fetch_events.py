...
SECTOR_BOARD_HINTS = {
    ...
    '稳定币/RWA/跨境支付': ['稳定币','RWA','数字货币','跨境支付','数字人民币','区块链','通证化','CIPS'],
    '模拟芯片/功率半导体': ['模拟芯片','功率半导体','电源管理','信号链','IGBT','SiC','GaN','功率器件'],
    '猪肉/养殖': ['猪肉','生猪','养殖','能繁母猪','猪价','饲料','屠宰','畜禽'],
    '消费电子/AI硬件': ['消费电子','AI手机','AI眼镜','AR','VR','果链','苹果产业链','换机'],
}
