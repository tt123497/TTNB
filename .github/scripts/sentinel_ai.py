...
4. newEvents: 列出未来30天内所有A股重要事件(不限赛道,财报/会议/政策/数据发布/产业催化/宏观数据), 每条必须标注具体日期(月+日), big=1表示硬催化(停产/涨价/法规/财报/宏观数据发布), big=0表示普通会议/数据, s字段写事件关联的赛道或行业名(可以是35赛道外的新赛道名), 格式: {{\"d\":\"7月1日\",\"icon\":\"...\",\"e\":\"标题\",\"s\":\"赛道名或行业名\",\"big\":1或0,\"desc\":\"说明\"}}
