...
EM_ALIAS = {
    ...
    '光通信':'CPO/硅光','CPO概念':'CPO/硅光','光模块':'CPO/硅光',
    '光纤光缆':'光纤光缆','光纤概念':'光纤光缆',
    ...
    'AI智能体':'AI智能体/应用','人工智能':'AI智能体/应用','大模型':'AI智能体/应用',
    '核电':'核电/核能','核能核电':'核电/核能',
...
def get_sector_definitions():
    ...
    return [
        ...
        '算电协同','电网设备/特高压','算力租赁/GPU云','Token工厂/模型推理','火电/电力运营',
        # 半导体全链
        ...
        '空间计算/物理AI','AI眼镜/AR硬件','AI智能体/应用','核电/核能','量子计算/量子科技','卫星互联网/北斗',
        # 新能源
...
def count_sector_news(data):
    ...
    kw_sector = {
        ...
        'CPO': 'CPO/硅光', '硅光': 'CPO/硅光', '光模块': '光模块', '光芯片': '光模块',
        ...
        'AI眼镜': 'AI眼镜/AR硬件', '智能眼镜': 'AI眼镜/AR硬件',
        'AI智能体': 'AI智能体/应用', '大模型': 'AI智能体/应用', 'AI应用': 'AI智能体/应用',
